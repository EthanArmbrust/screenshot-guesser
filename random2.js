...
var showEpisodeName = document.createTextNode(episodeName);
...
function checkUserInput(){
	...
	if(userEpisode == episodeName)
	{
	var responseToUser = document.createTextNode("Correct!");
	}
	else var responseToUser = document.createTextNode("Wrong!");
	document.body.appendChild(responseToUser);
